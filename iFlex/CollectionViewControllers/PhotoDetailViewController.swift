...
class PhotoDetailViewController: UIViewController {
    ...
    //static let customColor = UIColor(
    ...
    private func setupImageView() {
        ...
        imageView.contentMode = .scaleAspectFit // Fills the entire space, may crop
        imageView.clipsToBounds = true // Prevent image from exceeding its bounds
